...
3. Read [Pet shop tutorial](http://truffleframework.com/tutorials/pet-shop)  (Est. time: 20 minutes)
4. Read the [Truffle Documentation](http://truffleframework.com/docs/)
5. Learn Ethereum development by making a [Zombie Game](https://cryptozombies.io/) (Est. time: 8 hs)
